<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.jar_id" placeholder="ID" style="width: 180px;" class="filter-item" />
      <el-input v-model="listQuery.jar_pos" placeholder="所在位置" style="width: 180px;" class="filter-item" />
    ...
    >
      <el-table-column align="center" label="指示灯ID" min-width="135">
        <template slot-scope="scope">
          <span>{{ scope.row.jar_id }}</span>
        </template>
      </el-table-column>
      <el-table-column min-width="90px" label="所在位置" align="center">
        <template slot-scope="scope">
